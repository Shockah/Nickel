...
public static class ReflectionExt
{
	...
	extension(PropertyInfo property)
	{
		...
		public Func<TValue> EmitStaticGetter<TValue>()
		{
		...
		public Action<TValue> EmitStaticSetter<TValue>()
		{
		...
		/// <typeparam name="TValue">The type of the property.</typeparam>
		/// <returns>A getter function.</returns>
		public Func<TOwner, TValue> EmitInstanceGetter<TOwner, TValue>()
		{
		...
		/// <typeparam name="TValue">The type of the property.</typeparam>
		/// <returns>A setter function.</returns>
		public Action<TOwner, TValue> EmitInstanceSetter<TOwner, TValue>()
		{
