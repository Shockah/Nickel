...
public sealed class ModEntry : SimpleMod
{
	...
	{
		{ "APurpleApple.GenericArtifacts", new() { { "NexusMods", """{"ID": 16}""" } } },
		{ "APurpleApple.Shipyard", new() { { "NexusMods", """{"ID": 6}""" }, { "GitHub", """{"Repository": "APurpleApple/APurpleApple_Shipyard"}""" } } },
		{ "Arin.Randall", new() { { "NexusMods", """{"ID": 30}""" } } },
		{ "clay.PhilipTheMechanic", new() { { "NexusMods", """{"ID": 38}""" } } },
		{ "Dave", new() { { "NexusMods", """{"ID": 35}""" } } },
		{ "Mezz.TwosCompany", new() { { "NexusMods", """{"ID": 26}""" }, { "GitHub", """{"Repository": "Mezzelo/TwosCompany"}""" } } },
		{ "pont.SaturnShip", new() { { "NexusMods", """{"ID": 27}""" } } },
		...
		{ "SoggoruWaffle.Tucker", new() { { "NexusMods", """{"ID": 50}""" }, { "GitHub", """{"Repository": "CupOfJim/Tucker-Mod"}""" } } },
		...
		{ "TheJazMaster.CombatQoL", new() { { "NexusMods", """{"ID": 49}""" } } },
